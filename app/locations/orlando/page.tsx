  ...
  return (
    <div style={{ fontFamily: "'Libre Franklin', 'Segoe UI', sans-serif", color: "#1a1a1a", background: "#ffffff", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", minHeight: 480, display: "flex", alignItems: "center", overflow: "hidden" }}>
        <img src="/OrlandoExterior.jpg" alt="Ata Dental Orlando Office" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 900, margin: "0 auto", padding: "100px 24px 80px" }}>
          ...
          <div style={{ marginTop: 32, display: "flex", gap: 16, flexWrap: "wrap" }}>
            ...
            <a href="tel:+14078576501" style={{ color: "white", textDecoration: "none", fontWeight: 600, fontSize: 16, padding: "16px 24px", border: "2px solid rgba(255,255,255,0.3)", borderRadius: 6, display: "inline-block" }}>
              📞 (407) 857-6501
            </a>
          </div>
        </div>
      ...
      <section style={{ padding: "80px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
          ...
          <div className="card">
            ...
            <a href="https://www.google.com/maps?cid=7531426336953562544" target="_blank" rel="noopener noreferrer" style={{ color: "var(--red)", fontWeight: 600, fontSize: 15, textDecoration: "none" }}>
              Get Directions →
            </a>
            <div style={{ marginTop: 24, padding: 16, background: "var(--grey-bg)", borderRadius: 8, fontSize: 14, color: "var(--grey)", lineHeight: 1.6 }}>
              Our own building with a dedicated parking lot — no public parking hassles. Spacious, ultra-modern, and relaxing interior.
            </div>
          </div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 15, color: "var(--grey)", lineHeight: 1.6 }}>
              Dental emergencies can happen at any time. We maintain an after-hours emergency phone line. <em>Hablamos Español.</em>
            </p>
          </div>
          <a href="tel:+14078576501" className="btn-primary" style={{ whiteSpace: "nowrap" }}>Call (407) 857-6501</a>
        </div>
      </section>
      ...
      <section style={{ background: "var(--grey-bg)", padding: "80px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 className="serif" style={{ fontSize: 32, marginBottom: 8 }}>Services at Our Orlando Office</h2>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 24 }}>
            ...
            <div className="card" style={{ borderTop: "3px solid var(--red)" }}>
              ...
              <p style={{ fontSize: 14, color: "var(--grey)", lineHeight: 1.6, marginBottom: 16 }}>Flexible payment plans with 0% APR options. No hard credit checks, no hidden fees.</p>
      ...
      <section style={{ padding: "80px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
          <div>
            ...
            <h2 className="serif" style={{ fontSize: 36, marginBottom: 12 }}>Experienced, Caring Dentists</h2>
            ...
            <p style={{ fontSize: 16, color: "var(--grey)", lineHeight: 1.75, marginBottom: 20 }}>
              Our Orlando office is staffed by a team of dedicated specialists covering cosmetic, restorative, implant, and emergency dentistry. From your first visit to your final result, we're with you every step of the way.
            </p>
      ...
      <section style={{ background: "var(--black)", padding: "60px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", color: "white" }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">Book Online — Orlando</a>
            <a href="/locations/kissimmee" className="btn-outline" style={{ color: "white", borderColor: "rgba(255,255,255,0.4)" }}>View Kissimmee Office</a>
          </div>
        </div>
      </section>
